      ...
      <header class="site-header">
        <div class="header-content">
          <a href="${basePath}index.html" class="brand" aria-label="Página inicial">
            <img class="logo-img" src="${basePath}assets/logo.svg" alt="Logo Dr. Gabriel Marcondes" />
          </a>
              ...
              <div class="footer-grid">
                 <div class="footer-brand">
                    <a href="${basePath}index.html" aria-label="Página inicial">
                      <img class="logo-img" src="${basePath}assets/logo-black.svg" alt="Logo Dr. Gabriel Marcondes" />
                    </a>
                 </div>
